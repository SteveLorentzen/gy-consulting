...
export function HeroImage() {
  return (
    <div className="relative">
      ...
      <div className="flex w-full h-112 xxs:h-136 xs:h-152 sm:h-160 lg:h-160 xl:h-172 2xl:h-192 3xl:h-224 max-w-screen-3xl  mx-auto flex-col sm:flex-row sm:items-stretch justify-end">
