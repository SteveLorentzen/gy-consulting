  ...
  return (
    <div className="relative">
      <div className="w-full h-full flex flex-col sm:flex-row sm:items-stretch justify-start bg-gradient-to-l from-cyan-900 to-cyan-700">
        <div className="w-full sm:w-full lg:w-7/12 xl:w-6/12 sm:-translate-x-12 lg:translate-x-0  ">
        ...
        <div className="relative grow sm:z-0">
          <div className="flex justify-center h-0 w-10/12 mx-auto sm:h-full -translate-y-16 xxs:-translate-y-24 xs:-translate-y-32 sm:-translate-y-0   text-white font-extrabold sm:font-normal ">
