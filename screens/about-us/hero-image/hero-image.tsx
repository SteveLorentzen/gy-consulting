    ...
    <div className="relative">
      <div className="w-full h-full flex flex-col sm:flex-row items-center sm:items-stretch justify-end bg-gradient-to-l from-cyan-900 to-cyan-700">
        ...
        <div className="relative grow sm:z-0">
          <div className="flex justify-center h-0 sm:h-full -translate-y-8 xs:-translate-y-12 sm:-translate-y-0 sm:-translate-x-24 lg:-translate-x-12 text-cyan-900 sm:text-white font-extrabold sm:font-normal ">
            <h1 className=" flex items-center text-xl xxs:text-2xl xs:text-4xl sm:text-5xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl">
